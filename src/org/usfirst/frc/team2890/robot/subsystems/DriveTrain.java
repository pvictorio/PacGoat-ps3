...
import org.usfirst.frc.team2890.robot.commands.DriveWithJoystick;
...
public class DriveTrain extends Subsystem {
	...
	//private Encoder rightEncoder = new Encoder(3, 4, true, EncodingType.k4X);	// 11/11/2018
	//private Encoder leftEncoder = new Encoder(1, 2, true, EncodingType.k4X);	// 11/11/2018
...
//		drive.setSensitivity(1.0);  // 11/11/2018
		drive.setMaxOutput(1.0);
//		drive.setMaxOutput(5.0);	// 11/11/2018
